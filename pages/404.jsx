...
import { BtnSecondary } from "components/ui/Btns";
...
export default function E404() {
  ...
  return (
    <>
      <NextSeo title="404 - Marwan Zayed | Back End Dev" />
      <main
        className={
          ...
          <center className="m-auto">
            ...
            <div className="tracking-widest mt-4">
              ...
              <p className="text-slate-600 dark:text-slate-100 mt-5 lg:text-lg mb-7">
                Sorry, I Can't Find This Path: {asPath}
              </p>
            </div>
          </center>
          <center className="mt-6">
            <BtnSecondary href="/" text="Go Home Page" />
          </center>
        </div>
      </main>
    </>
